...
include '../koneksi.php';
		...
		$html = file_get_html('https://indoagenda.com/agenda-makasar.html?page=2');
 ...
 for($a=0;$a<=$jum;$a++)
		...
		$select = mysqli_query($koneksi,"select id_event from event where link_Detail = '$link[$no]'");	
		...
		if($d > 0){
			...
			mysqli_query($koneksi, "
				update event set nama_event='$nama_event[$no]',lokasi ='$lokasi[$no]', tanggal ='$fix[$no]', sumber='KatalogPromosi',
